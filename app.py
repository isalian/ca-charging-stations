...
from getdata import get_stations, get_stations_by_zipcode, count_station_ownership, get_station_by_id, get_zipcodes, get_station_address
...
def stationpage(idval):
	...
	return render_template('station.html', station=station, address=get_station_address(station))
